...
exports.mpc_preprocessing_vote_person = function (app: any) {
  ...
  if (security_checks) {
    jiff_instance.preprocessing('clteq', jiff_instance.party_count * 5 + 1); // 1 + party_count * 4 + party_count
    jiff_instance.preprocessing('smult', jiff_instance.party_count * 5 + 4); // party_count * 4 + party_count + 4
  }
