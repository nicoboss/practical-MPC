    ...
    template: `
      ...
      <tab-panels v-model="selectedTab" :animate="true">
        ...
        <tab-panel val="Abstimmung">
          <h3>Stimmabgabe für einen Kanditaten</h3>
        ...
        <tab-panel val="Threshold">
          <h3>Zählt alle Eingaben die über einem Schwellenwert (Threshold) liegen</h3>
          <div class="command-div one-liner-box d-flex">
        ...
        <tab-panel val="SumThreshold">
          <h3>Prüft ob die Summe aller Eingaben über einem Schwellenwert liegen</h3>
          <div class="command-div one-liner-box d-flex">
